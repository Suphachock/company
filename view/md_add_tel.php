<div class="modal" tabindex="-1" id="md_add_tel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="add_tel" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="row align-items-center mb-3">
                        <div class="col-md-3">
                            <label for="tel_img" class="form-label">รูปเว็บไซต์</label>
                        </div>
                        <div class="col-md-9">
                            <input type="file" name="tel_img" class="form-control" accept="image/*" onchange="previewImage(event)" required>
...
<script>
    $(document).ready(function() {
        $('#add_tel').on('submit', function(event) {
            event.preventDefault();
            let formData = new FormData(this);
            $.ajax({
                url: '../model/add_tel.php', // The URL of your PHP script
